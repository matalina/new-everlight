<script lang="ts">
  ...
  import { debilitatingInjuryChaosTable, debilitatingInjuryElementalTable, debilitatingInjuryNecroticTable, debilitatingInjuryPhysicalTable, debilitatingInjuryPsychicTable, debilitatingInjuryRadiantTable, debilitatingInjuryShadowTable, debilitatingInjuryToxicTable, lastingScarChaosTable, lastingScarElementalTable, lastingScarNecroticTable, lastingScarPhysicalTable, lastingScarPsychicTable, lastingScarRadiantTable, lastingScarShadowTable, lastingScarToxicTable, lingeringTraumaChaosTable, lingeringTraumaElementalTable, lingeringTraumaNecroticTable, lingeringTraumaPhysicalTable, lingeringTraumaPsychicTable, lingeringTraumaRadiantTable, lingeringTraumaShadowTable, lingeringTraumaToxicTable, strainChaosTable, strainElementalTable, strainNecroticTable, strainPhysicalTable, strainPsychicTable, strainRadiantTable, strainShadowTable, strainToxicTable } from "../../data/everlight";
